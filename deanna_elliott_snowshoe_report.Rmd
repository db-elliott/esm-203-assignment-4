...
- Hind foot length appears moderately positively correlated with body mass in juvenile hares; The relationship (by simple linear regression) is significant, with a slope (expected average increase in weight with a 1 mm increase in hind foot length) of shows a slope of `r round(hares_lm$coefficients [2], 2)` g/mm.
